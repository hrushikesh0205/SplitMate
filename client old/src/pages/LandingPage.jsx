...
import { ShieldCheck, Zap, Users, BarChart3, Bell, Lock } from 'lucide-react';
  ...
  return (
    <div className='landing'>
      ...
      <section className='hero'>
        <div className='hero-badge'>✨ Free forever for personal use</div>
        ...
        <div className='hero-trust'>
          ...
          <span className='hero-trust-item'>
            <ShieldCheck size={16} /> Instant setup
          </span>
        </div>
      </section>
      ...
      <div className='hero-visual'>
        <div className='hero-illustration'>
          ...
          <svg className='illus-lines' viewBox='0 0 400 400'>
            <line x1='200' y1='200' x2='80' y2='80' stroke='var(--primary)' strokeWidth='1' strokeDasharray='6 4' opacity='0.2' />
            <line x1='200' y1='200' x2='320' y2='80' stroke='var(--primary)' strokeWidth='1' strokeDasharray='6 4' opacity='0.2' />
            <line x1='200' y1='200' x2='60' y2='300' stroke='var(--primary)' strokeWidth='1' strokeDasharray='6 4' opacity='0.2' />
            <line x1='200' y1='200' x2='340' y2='300' stroke='var(--primary)' strokeWidth='1' strokeDasharray='6 4' opacity='0.2' />
            <circle cx='200' cy='200' r='120' stroke='var(--primary)' strokeWidth='0.8' strokeDasharray='8 6' fill='none' opacity='0.1' />
            <circle cx='200' cy='200' r='170' stroke='var(--accent)' strokeWidth='0.8' strokeDasharray='8 6' fill='none' opacity='0.08' />
          </svg>
        </div>
      </div>
